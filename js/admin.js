...
// CZĘŚĆ 5/5: MAŁE MODUŁY, MODAL I ZAKOŃCZENIE
  ...
  function showModalWithData(id, d){
    ...
    const entryModalTitle = $('entryModalTitle'), entryModalMeta = $('entryModalMeta'), entryModalBody = $('entryModalBody');
  ...
  const modalCloseBtn = $('modalCloseBtn'), modalCloseBtn2 = $('modalCloseBtn2');
