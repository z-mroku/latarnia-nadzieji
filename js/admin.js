// Plik: /js/admin.js (WERSJA NAPRAWCZA - ZGODNA Z ORYGINAŁEM)
...
// Uruchamiamy logikę panelu dopiero wtedy, gdy Firebase potwierdzi, że użytkownik jest zalogowany.
onAuthStateChanged(auth, user => {
    if (user) {
        // Użytkownik jest zalogowany, więc uruchamiamy całą logikę.
        console.log("✅ Użytkownik jest zalogowany. Uruchamiam panel admina...");
        document.body.style.visibility = 'visible';
        runAdminPanel(user); // Uruchamiamy Twoją funkcję opakowującą
    } else {
...
function runAdminPanel(user) {
    //
    // Twoja oryginalna funkcja nasłuchująca na DOMContentLoaded
    // jest teraz tutaj, aby wykonać się we właściwym momencie.
    //
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // Ta funkcja jest teraz bezpiecznie wywoływana w środku
