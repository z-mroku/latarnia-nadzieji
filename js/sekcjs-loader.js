...
import { init as initBottleSection } from './modules/list-w-butelce.js'; // <-- DODANE
...
const SectionLoader = {
  ...
  router: {
    ...
    'List w Butelce': { fetcher: 'fetchNoOp', renderer: 'renderBottleSection', theme: 'theme-bottle' }, // <-- DODANE
  ...
  render: {
    renderBottleSection() { // <-- DODANE
        // Ta funkcja po prostu wywołuje logikę z dedykowanego modułu.
        // Przekazujemy jej obiekt 'db', którego potrzebuje do działania.
        initBottleSection(db);
    },
    renderPiciorys(doc) {
